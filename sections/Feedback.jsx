  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <motion.div
        ...
        className="flex-[0.5] lg:max-w-[370px] flex justify-end flex-col gradient-05 sm:p=8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a6a] relative"
      >
        <div className="feedback-gradient"></div>
        <div>
          <h4 className="font-bod sm:text-[32px] tex-[26px] sm:leading-[40px] leading-[36px] text-white">Samantha</h4>
